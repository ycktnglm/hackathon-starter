...
app.get('/auth/facebook', passport.authenticate('facebook', { scope: ['email', 'user_location', 'public_profile', 'user_posts', 'user_hometown', 'user_about_me', 'user_friends', 'user_photos'] }));
